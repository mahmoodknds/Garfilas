  ...
  return (
    <nav className="bottom-nav" aria-label="ناوبری اصلی">
      <style>{`
        ...
        .bottom-nav-link-1 { left:50%!important;top:45.671875%!important;width:clamp(4.1975rem,15.64vw,5.3475rem)!important;height:clamp(4.1975rem,15.64vw,5.3475rem)!important;border-width:1.5px;z-index:4;background:rgba(7,5,4,.9);box-shadow:0 0 8px rgba(255,91,0,.9),0 0 26px rgba(255,91,0,.28),inset 0 0 12px rgba(255,91,0,.14); }

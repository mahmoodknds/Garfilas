...
export default function BottomNavigation() {
  return (
    <nav className="bottom-nav" aria-label="ناوبری اصلی">
      <style>{`
        .bottom-nav { position:fixed!important;left:0!important;right:0!important;bottom:0!important;width:100vw!important;height:20vw!important;min-height:0!important;padding:0!important;margin:0!important;transform:none!important;display:block!important;visibility:visible!important;opacity:1!important;background:transparent!important;border:0!important;border-radius:0!important;box-shadow:none!important;backdrop-filter:none!important;overflow:visible!important;isolation:isolate;contain:layout paint;z-index:9999!important;pointer-events:none!important; }
        .bottom-nav-frame { position:absolute;left:0;top:0;width:100%;height:100%;display:block;z-index:0;pointer-events:none;object-fit:fill;visibility:visible!important;opacity:1!important; }
        .bottom-nav-link { position:absolute!important;z-index:2;display:grid!important;place-items:center!important;margin:0!important;padding:0!important;transform:translate(-50%,-50%)!important;flex:none!important;visibility:visible!important;opacity:1!important;pointer-events:auto!important;color:#ff8a18;border:2px solid rgba(255,106,0,.9);border-radius:50%;background:rgba(7,5,4,.72);box-shadow:0 0 7px rgba(255,91,0,.72),0 0 18px rgba(255,91,0,.22),inset 0 0 8px rgba(255,91,0,.12); }
        .bottom-nav-link-0 { left:16.4%!important;top:65.8125%!important;width:clamp(2.8rem,11.5vw,3.6rem)!important;height:clamp(2.8rem,11.5vw,3.6rem)!important; }
        ...
        .bottom-nav-link-2 { left:83.6%!important;top:65.8125%!important;width:clamp(2.8rem,11.5vw,3.6rem)!important;height:clamp(2.8rem,11.5vw,3.6rem)!important; }

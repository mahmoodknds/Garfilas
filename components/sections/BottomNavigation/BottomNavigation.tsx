  ...
  return (
    <nav className="bottom-nav" aria-label="ناوبری اصلی">
      <style>{`
        ...
        .bottom-nav-link-1 { left:50%!important;top:56.671875%!important;width:clamp(3.65rem,13.6vw,4.65rem)!important;height:clamp(3.65rem,13.6vw,4.65rem)!important;border-width:1.5px;z-index:4;background:rgba(7,5,4,.9);box-shadow:0 0 8px rgba(255,91,0,.9),0 0 26px rgba(255,91,0,.28),inset 0 0 12px rgba(255,91,0,.14); }
        .bottom-nav-link-1::after { content:"";position:absolute;bottom:-.56rem;width:.36rem;height:.36rem;border-radius:50%;background:#ff7b0b;box-shadow:0 0 8px rgba(255,91,0,.9); }
        ...
        .bottom-nav-link-1 svg { width:1.95rem;height:1.95rem; }

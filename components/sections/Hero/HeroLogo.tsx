  ...
  return (
    <div className="hero-logo-lockup" aria-label="Garfilas Italian Lasagna">
      <style>{`
        ...
        .hero-italy-flag{position:relative;width:clamp(2.7rem,7vw,4.5rem);height:3px;margin:.55rem auto 0;display:flex;overflow:hidden;isolation:isolate;clip-path:polygon(0 50%,14% 0,86% 0,100% 50%,86% 100%,14% 100%);mask-image:linear-gradient(90deg,transparent 0%,#000 12%,#000 88%,transparent 100%);-webkit-mask-image:linear-gradient(90deg,transparent 0%,#000 12%,#000 88%,transparent 100%);filter:none;box-shadow:0 0 1px rgba(255,226,165,.35),0 0 3px rgba(255,122,0,.2);opacity:.92}
        ...
        @media(max-width:699px){.hero-product-lockup{width:min(92vw,23rem);margin-top:-.72rem;gap:.48rem}.hero-product-line{min-width:2.2rem;max-width:5rem}.hero-product-name{font-size:clamp(.82rem,4.25vw,1.16rem);letter-spacing:.13em;text-indent:.13em;transform:scaleX(.9)}.hero-italy-flag{width:clamp(2.55rem,10vw,3.15rem);height:2.5px;margin-top:.48rem}.hero-slogan{margin-top:.72rem;font-size:clamp(.68rem,3vw,.82rem)}}
        @media(min-width:700px){.hero-product-lockup{width:min(68vw,28rem);margin-top:-.82rem;gap:.9rem}.hero-product-line{min-width:5rem;max-width:8rem}.hero-product-name{font-size:1.45rem;letter-spacing:.18em;text-indent:.18em}.hero-italy-flag{width:5rem;height:3px;margin-top:.58rem}.hero-slogan{margin-top:.9rem;font-size:.92rem}}
      `}</style>

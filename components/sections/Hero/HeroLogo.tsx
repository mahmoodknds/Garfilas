export default function HeroLogo() {
  return (
    <div className="hero-logo-lockup" aria-label="Garfilas Italian Lasagna">
      <style>{`
        .hero-product-lockup{display:flex;align-items:center;justify-content:center;width:min(82vw,31rem);margin-top:-.64rem;gap:clamp(.62rem,2.2vw,.9rem)}
        ...
        .hero-product-name{flex:0 0 auto;margin:0;color:#ff9a24;font-family:"Bodoni 72","Didot","Bodoni MT",Georgia,"Times New Roman",serif;font-size:clamp(.94rem,4vw,1.38rem);font-weight:400;line-height:.9;letter-spacing:.27em;text-indent:.27em;text-transform:uppercase;white-space:nowrap;transform:scaleX(.94);transform-origin:center;text-shadow:0 0 .45px #fff9dc,0 0 1.2px #ffe0a0,0 0 2.5px #ffad42,0 0 4.5px rgba(255,122,0,.9),0 0 9px rgba(255,91,0,.56),0 0 16px rgba(255,72,0,.25)}
        ...
        @media(max-width:699px){.hero-product-lockup{width:min(88vw,25rem);margin-top:-.70rem;gap:.52rem}.hero-product-line{min-width:2.55rem;max-width:5.35rem}.hero-product-name{font-size:clamp(.86rem,4.45vw,1.2rem);letter-spacing:.22em;text-indent:.22em;transform:scaleX(.94)}.hero-italy-flag{width:clamp(2.8rem,10vw,3.45rem);height:2.35px;margin-top:.5rem}.hero-slogan{margin-top:.72rem;font-size:clamp(.7rem,3.15vw,.86rem)}}
        @media(min-width:700px){.hero-product-lockup{width:min(68vw,30rem);margin-top:-.78rem;gap:.88rem}.hero-product-line{min-width:5rem;max-width:7.8rem}.hero-product-name{font-size:1.42rem;letter-spacing:.29em;text-indent:.29em}.hero-italy-flag{width:5rem;height:2.5px;margin-top:.58rem}.hero-slogan{margin-top:.9rem;font-size:.96rem}}
      `}</style>

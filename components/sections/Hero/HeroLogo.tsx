  ...
  return (
    <div className="hero-logo-lockup" aria-label="Garfilas Italian Lasagna">
      <style>{`
        ...
        @media(max-width:699px){.hero-product-lockup{width:min(88vw,25rem);margin-top:-.70rem;gap:.58rem}.hero-product-line{min-width:2.55rem;max-width:5.35rem}.hero-product-name{font-size:clamp(.86rem,4.45vw,1.2rem);letter-spacing:.34em;text-indent:.34em;transform:scaleX(.94)}.hero-italy-flag{width:clamp(2.8rem,10vw,3.45rem);height:2.35px;margin-top:.5rem}.hero-slogan{margin-top:.72rem;font-size:clamp(.7rem,3.15vw,.86rem)}}
        @media(min-width:700px){.hero-product-lockup{width:min(68vw,30rem);margin-top:-.78rem;gap:.98rem}.hero-product-line{min-width:5rem;max-width:7.8rem}.hero-product-name{font-size:1.42rem;letter-spacing:.44em;text-indent:.44em}.hero-italy-flag{width:5rem;height:2.5px;margin-top:.58rem}.hero-slogan{margin-top:.9rem;font-size:.96rem}}
      `}</style>

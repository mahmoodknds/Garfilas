  ...
  return (
    <div className="hero-logo-lockup" aria-label="Garfilas Italian Lasagna">
      <style>{`
        ...
        .hero-product-line{display:block;flex:1 1 0;height:.7px;min-width:2.9rem;max-width:5.8rem;background:linear-gradient(90deg,rgba(255,111,8,0),rgba(255,129,15,.52) 16%,#f4a12b 40%,#ffd36f 50%,#f4a12b 60%,rgba(255,129,15,.52) 84%,rgba(255,111,8,0));box-shadow:0 0 .2px rgba(255,220,143,.72),0 0 1px rgba(255,177,58,.52),0 0 2.5px rgba(255,105,4,.22),0 0 5px rgba(255,71,0,.06);opacity:.84}

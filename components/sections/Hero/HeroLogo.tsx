  ...
  return (
    <div className="hero-logo-lockup" aria-label="Garfilas Italian Lasagna">
      <style>{`
        ...
        .hero-italy-flag{width:clamp(5.8rem,22vw,7.2rem);height:clamp(.16rem,.65vw,.24rem);margin:.52rem auto 0;display:flex;overflow:hidden;clip-path:polygon(0 50%,8% 0,92% 0,100% 50%,92% 100%,8% 100%);filter:drop-shadow(0 0 2px rgba(255,122,0,.28));opacity:.96}
        .hero-italy-flag span{height:100%;flex:1 1 33.333%}
        .hero-italy-green{background:#009246}.hero-italy-white{background:#f4f1e8}.hero-italy-red{background:#ce2b37}
        ...
        @media(max-width:699px){.hero-product-lockup{width:min(92vw,23rem);margin-top:-.72rem;gap:.48rem}.hero-product-line{min-width:2.2rem;max-width:5rem}.hero-product-name{font-size:clamp(.82rem,4.25vw,1.16rem);letter-spacing:.13em;text-indent:.13em;transform:scaleX(.9)}.hero-italy-flag{width:clamp(5.3rem,25vw,6.5rem);height:.18rem;margin-top:.48rem}.hero-slogan{margin-top:.72rem;font-size:clamp(.68rem,3vw,.82rem)}}
        @media(min-width:700px){.hero-product-lockup{width:min(68vw,28rem);margin-top:-.82rem;gap:.9rem}.hero-product-line{min-width:5rem;max-width:8rem}.hero-product-name{font-size:1.45rem;letter-spacing:.18em;text-indent:.18em}.hero-italy-flag{width:7.4rem;height:.22rem;margin-top:.56rem}.hero-slogan{margin-top:.9rem;font-size:.92rem}}
      `}</style>

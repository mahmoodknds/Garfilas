  ...
  return (
    <div className="hero-logo-lockup" aria-label="Garfilas Italian Lasagna">
      <style>{`
        ...
        .hero-slogan{margin-top:clamp(.72rem,2.5vw,1rem);color:#ffb347;font-family:"Brush Script MT","Segoe Script","URW Chancery L","Apple Chancery",cursive;font-size:clamp(1.02rem,4vw,1.38rem);font-weight:400;font-style:normal;line-height:1.05;letter-spacing:.005em;text-align:center;white-space:nowrap;text-shadow:0 0 .45px #fff2cf,0 0 2px rgba(255,179,71,.65),0 0 7px rgba(255,122,0,.25)}
        @media(max-width:699px){.hero-product-lockup{width:min(92vw,23rem);margin-top:-.72rem;gap:.48rem}.hero-product-line{min-width:2.2rem;max-width:5rem}.hero-product-name{font-size:clamp(.82rem,4.25vw,1.16rem);letter-spacing:.13em;text-indent:.13em;transform:scaleX(.9)}.hero-slogan{margin-top:.72rem;font-size:clamp(.88rem,4vw,1.08rem);letter-spacing:0}}
        @media(min-width:700px){.hero-product-lockup{width:min(68vw,28rem);margin-top:-.82rem;gap:.9rem}.hero-product-line{min-width:5rem;max-width:8rem}.hero-product-name{font-size:1.45rem;letter-spacing:.18em;text-indent:.18em}.hero-slogan{margin-top:.9rem;font-size:1.18rem}}
      `}</style>

  ...
  return (
    <div className="hero-logo-lockup" aria-label="Garfilas Italian Lasagna">
      <style>{`
        ...
        .hero-product-line{display:block;flex:1 1 0;height:1px;min-width:3rem;max-width:7.2rem;background:linear-gradient(90deg,rgba(255,122,0,.10),#ff8b18 18%,#fff0c2 50%,#ff8b18 82%,rgba(255,122,0,.10));box-shadow:0 0 .55px #fff7d6,0 0 2px rgba(255,202,112,.95),0 0 5px rgba(255,122,0,.72),0 0 10px rgba(255,82,0,.28);opacity:.95}
        .hero-product-name{flex:0 0 auto;margin:0;color:#ffd79a;font-family:"Bodoni Moda","Bodoni 72","Didot","Bodoni MT","Times New Roman",serif;font-optical-sizing:auto;font-size:clamp(.94rem,4vw,1.38rem);font-weight:300;line-height:.9;letter-spacing:.50em;text-indent:.50em;text-transform:uppercase;white-space:nowrap;transform:scaleX(.91);transform-origin:center;filter:brightness(1.22) saturate(.92);text-shadow:0 0 .20px #ffffff,0 0 .65px #fff3cf,0 0 1.5px rgba(255,224,164,.98),0 0 3px rgba(255,176,76,.82),0 0 6px rgba(255,126,18,.52),0 0 12px rgba(255,101,0,.22)}

export default function HeroLogo() {
  return (
    <div className="hero-logo-lockup" aria-label="Garfilas Italian Lasagna">
      <style>{`
        .hero-product-lockup{display:flex;align-items:center;justify-content:center;width:min(60vw,36rem);margin-top:-.64rem;gap:clamp(.72rem,1.8vw,1.12rem)}
        .hero-product-line{display:block;flex:1 1 0;height:.7px;min-width:3.8rem;max-width:6.7rem;background:linear-gradient(90deg,rgba(255,111,8,0),rgba(255,129,15,.52) 16%,#f4a12b 40%,#ffd36f 50%,#f4a12b 60%,rgba(255,129,15,.52) 84%,rgba(255,111,8,0));box-shadow:0 0 .2px rgba(255,220,143,.72),0 0 1px rgba(255,177,58,.52),0 0 2.5px rgba(255,105,4,.22),0 0 5px rgba(255,71,0,.06);opacity:.84}
        .hero-product-name{flex:0 0 auto;margin:0;font-family:var(--font-cormorant-garamond),serif;font-size:clamp(.94rem,2.78vw,1.38rem);font-weight:300;line-height:.76;letter-spacing:.58em;text-indent:.58em;text-transform:uppercase;white-space:nowrap;transform:scaleX(.86);transform-origin:center;background:linear-gradient(180deg,#ffd06f 0%,#f5a32b 46%,#df7e13 100%);-webkit-background-clip:text;background-clip:text;color:transparent;-webkit-text-fill-color:transparent;-webkit-text-stroke:0;filter:brightness(1.14) saturate(1.02);text-rendering:geometricPrecision;-webkit-font-smoothing:antialiased;text-shadow:0 0 .14px rgba(255,226,159,.92),0 0 .5px rgba(255,192,78,.72),0 0 1.5px rgba(255,139,19,.42),0 0 3.5px rgba(255,88,0,.2),0 0 6px rgba(255,68,0,.07)}
        ...
        @media(max-width:699px){.hero-product-lockup{width:min(74vw,24rem);margin-top:-.70rem;gap:clamp(.52rem,2vw,.76rem)}.hero-product-line{height:.65px;min-width:2rem;max-width:3.9rem}.hero-product-name{font-size:clamp(.82rem,3.5vw,1.04rem);letter-spacing:.55em;text-indent:.55em;transform:scaleX(.84)}.hero-italy-flag{width:clamp(2.8rem,10vw,3.45rem);height:2.35px;margin-top:.5rem}.hero-slogan{margin-top:.72rem;font-size:clamp(.7rem,3.15vw,.86rem)}}
        @media(min-width:700px){.hero-product-lockup{width:min(60vw,36rem);margin-top:-.78rem;gap:clamp(.72rem,1.8vw,1.12rem)}.hero-product-line{height:.7px;min-width:3.8rem;max-width:6.7rem}.hero-product-name{font-size:clamp(1rem,2.48vw,1.48rem);letter-spacing:.58em;text-indent:.58em;transform:scaleX(.86)}.hero-italy-flag{width:5rem;height:2.5px;margin-top:.58rem}.hero-slogan{margin-top:.9rem;font-size:.96rem}}
      `}</style>

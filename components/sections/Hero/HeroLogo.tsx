  ...
  return (
    <div className="hero-logo-lockup" aria-label="Garfilas Italian Lasagna">
      <style>{`
        ...
        @media(max-width:699px){.hero-product-lockup{width:min(74vw,24rem);margin-top:-.70rem;gap:clamp(.72rem,2.8vw,.96rem)}.hero-product-line{height:.65px;min-width:2rem;max-width:3.9rem}.hero-product-name{font-size:clamp(.78rem,3.2vw,.94rem);letter-spacing:.55em;text-indent:.55em;transform:scaleX(.84)}.hero-italy-flag{width:clamp(2.8rem,10vw,3.45rem);height:2.35px;margin-top:.5rem}.hero-slogan{margin-top:.72rem;font-size:clamp(.7rem,3.15vw,.86rem)}}
        @media(min-width:700px){.hero-product-lockup{width:min(60vw,36rem);margin-top:-.78rem;gap:clamp(1.02rem,2.35vw,1.45rem)}.hero-product-line{height:.7px;min-width:3.8rem;max-width:6.7rem}.hero-product-name{font-size:clamp(.96rem,2.35vw,1.42rem);letter-spacing:.58em;text-indent:.58em;transform:scaleX(.86)}.hero-italy-flag{width:5rem;height:2.5px;margin-top:.58rem}.hero-slogan{margin-top:.9rem;font-size:.96rem}}
      `}</style>

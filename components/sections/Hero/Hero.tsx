...
const referenceHeroStyles = `
  /* Brand lockup: calibrated to the approved Front Site reference. */
  .hero .hero-copy {
    top:49.6%;
  ...
  .hero .hero-product-line {
    flex:0 0 auto;
    width:clamp(2.0rem,10vw,3.7rem);
    height:1px;
  ...
  @media (max-width:699px) {
    ...
    .hero .hero-product-line { width:clamp(1.8rem,10vw,3.0rem); }
    .hero .hero-flag { margin-top:.38rem; }
    .hero .hero-flag img { width:1.75rem; }
    .hero .hero-tagline {
      margin-top:.28rem;
      font-size:clamp(.76rem,3.25vw,.92rem);
    }
  }

...
export default function GlowButton({ children, id }: Props) {
  ...
  return (
    <span
      ...
      role="presentation"
    >
      <style>{`@import url('https://fonts.googleapis.com/css2?family=Lalezar&display=swap'); .garfilas-menu-fa{font-family:'Lalezar',sans-serif!important;font-size:clamp(1.22rem,4.8vw,1.54rem)!important;font-weight:400!important;line-height:1!important;letter-spacing:.01em!important;color:#fff0d0!important;text-shadow:0 0 2px rgba(255,240,210,.9),0 0 7px rgba(255,143,25,.5)!important;display:inline-block;transform:translateY(-1px)} .garfilas-menu-en{font-family:Georgia,'Times New Roman',serif!important;font-size:clamp(1.22rem,4.55vw,1.5rem)!important;font-weight:700!important;font-style:italic!important;line-height:1!important;letter-spacing:.025em!important}`}</style>

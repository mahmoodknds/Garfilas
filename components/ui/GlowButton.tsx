  ...
  return (
    ...
    >
      ...
      <span aria-hidden="true" className="absolute left-[8%] grid h-5 w-5 place-items-center">
        <span className="absolute h-[2px] w-[2px] rounded-full bg-[#fff1c8] shadow-[0_0_5px_rgba(255,225,151,1),0_0_10px_rgba(255,146,28,.9)] animate-[ping_2.1s_ease-out_infinite]" />
        <span className="relative text-[.76rem] leading-none text-[#ffd778] drop-shadow-[0_0_3px_rgba(255,208,105,.95)] animate-[pulse_1.55s_ease-in-out_infinite] transition-transform duration-300 group-hover:scale-125">✦</span>
      </span>
      ...
      <span aria-hidden="true" className="absolute right-[8%] grid h-5 w-5 place-items-center">
        <span className="absolute h-[2px] w-[2px] rounded-full bg-[#fff1c8] shadow-[0_0_5px_rgba(255,225,151,1),0_0_10px_rgba(255,146,28,.9)] animate-[ping_2.35s_ease-out_infinite] [animation-delay:.45s]" />
        <span className="relative text-[.76rem] leading-none text-[#ffd778] drop-shadow-[0_0_3px_rgba(255,208,105,.95)] animate-[pulse_1.7s_ease-in-out_infinite] [animation-delay:.3s] transition-transform duration-300 group-hover:scale-125">✦</span>
      </span>
    </span>
  );
}

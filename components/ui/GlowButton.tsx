...
export default function GlowButton({ children, id }: Props) {
  ...
  return (
    <span
      ...
      style={{ animation: "cta-neon-breathe 1s ease-in-out infinite" }}
      role="presentation"
    >
      <style>{`@import url('https://fonts.googleapis.com/css2?family=Noto+Nastaliq+Urdu:wght@400&display=swap'); .garfilas-menu-fa{font-family:'Noto Nastaliq Urdu',serif!important;font-size:clamp(1.08rem,4.25vw,1.38rem)!important;font-weight:400!important;line-height:1.35!important;letter-spacing:0!important;color:#fff0d0!important;text-shadow:0 0 2px rgba(255,240,210,.9),0 0 7px rgba(255,143,25,.5)!important;display:inline-block;transform:translateY(-1px)} .garfilas-menu-en{font-family:Georgia,'Times New Roman',serif!important;font-size:clamp(1.22rem,4.55vw,1.5rem)!important;font-weight:700!important;font-style:italic!important;line-height:1!important;letter-spacing:.025em!important}`}</style>
      ...
      {isBilingualMenu ? (
        <span className="relative z-10 flex flex-row-reverse items-center gap-[.42rem] whitespace-nowrap transition-transform duration-300 group-hover:scale-[1.018]">
